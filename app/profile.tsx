...
export default function ProfileScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}><KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={styles.flex}><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
    ...
    <View style={styles.sectionHeadingRow}><Text style={styles.sectionHeading}>每日施工</Text><Text style={styles.sectionPlant}>🪴</Text></View>
...
const styles=StyleSheet.create({
  ...
  pageDecor:{bottom:0,left:0,overflow:'hidden',position:'absolute',right:0,top:0,zIndex:-1},sparkRowA:{color:'rgba(211,162,115,0.34)',fontSize:18,left:-22,letterSpacing:8,position:'absolute',top:120,transform:[{rotate:'-18deg'}]},sparkRowB:{color:'rgba(211,162,115,0.28)',fontSize:17,letterSpacing:8,position:'absolute',right:-26,top:360,transform:[{rotate:'-18deg'}]},sparkRowC:{color:'rgba(211,162,115,0.25)',fontSize:18,left:-18,letterSpacing:8,position:'absolute',top:720,transform:[{rotate:'-18deg'}]},sparkRowD:{color:'rgba(211,162,115,0.22)',fontSize:17,letterSpacing:8,position:'absolute',right:-24,top:1050,transform:[{rotate:'-18deg'}]},
